...
long sevSeg_counter  = 0; //a counter for the sevSeg task to divide the 100us clock
int  sevSeg_number   = 0; //the current number being displayed on the sevSeg display
